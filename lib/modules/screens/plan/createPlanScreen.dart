...
class CreateplanScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<LayoutCubit, LayoutStates>(listener: (context, state) {
      if (state is CreateMyplanSuccessfullyState) {
        cubit.planImageFile = null;
      ...
      return Scaffold(
        ...
        appBar: AppBar(
          ...
          leadingWidth: 14.w,
          actions: [
            state is CreateMyplanLoadingState
                ? Padding(
                      ...
                      onTap: () {
                        if (cubit.planImageFile != null &&
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                              snackBarWidget(
                                  message: "TextFormField mustn't be empty!",
                                  context: context,
                                  color: Colors.red));
                        } else {
                          ScaffoldMessenger.of(context).showSnackBar(
                              snackBarWidget(
                                  message: "Plan's Image mustn't be empty!",
                                  context: context,
                                  color: Colors.red));
                        }
                      },
        ...
        body: cubit.userData == null
            ...
            : buildplanItem(context: context, cubit: cubit),
      );
    });
  }
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                        ...
                        hintText: "type Plan's title here...",
                    ...
                    Stack(
                      ...
                      children: [
                        SizedBox(
                            ...
                            child:
                                Image(image: FileImage(cubit.planImageFile!))),
                        GestureDetector(
                          onTap: () {
                            cubit.canceledplanImage();
                          },
                          child: Container(
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: "type Plan's description here...",
                      hintStyle: Theme.of(context)
                          .textTheme
                          .caption!
                          .copyWith(fontSize: 14),
