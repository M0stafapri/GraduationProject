    ...
    return BlocConsumer<LayoutCubit, LayoutStates>(
      ...
      builder: (context, state) {
        return Scaffold(
          ...
          body: Padding(
            padding:
                const EdgeInsets.symmetric(vertical: 2.5, horizontal: 15.0),
            child: Column(
    ...
    return Row(
      children: [
        ...
        Expanded(
            child: InkWell(
          onDoubleTap: () {
            // Todo: Delete it if I made it or Plan Author have also the ability to do this
            if (model.commentMakerID == userID ||
                widget.planAuthorID == userID) {
              showAlertDialog(
                context: context,
                content: Column(
