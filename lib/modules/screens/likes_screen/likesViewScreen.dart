...
class LikesViewScreen extends StatelessWidget {
  final String planID,
      planAuthorID,
      recipeID,
      recipeMakerID; // to enable to get the comments for this Recipe
  const LikesViewScreen(
      {super.key,
      required this.planID,
      required this.planAuthorID,
      required this.recipeID,
      required this.recipeMakerID});
  @override
  Widget build(BuildContext context) {
    return Builder(builder: (context) {
      LayoutCubit.getInstance(context).getLikesForSpecificRecipe(
          planID: planID,
      ...
      return BlocConsumer<LayoutCubit, LayoutStates>(
        ...
        builder: (context, state) {
          ...
          return Scaffold(
            ...
            body: Padding(
              padding:
                  EdgeInsets.symmetric(vertical: 12.5.h, horizontal: 14.0.w),
              child: Column(
